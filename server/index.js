...
const constr=`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}admin:csse4103@postitcluster.xjyi06f.mongodb.net/${process.env.DB_NAME}?retryWrites=true&w=majority&appName=PostITCluster`
